"""Seed the database with an initial admin user and starter content.
...
ADMIN_EMAIL = "admin@tauqeermustafa.tech"
...
SERVICES = [
    {
        ...
        "short_description": "Secure web platforms, portals, dashboards, and product systems built for scale.",
        "description": "We design and build maintainable enterprise web applications with clear architecture, reliable delivery practices, and performance-minded implementation. Every engagement starts with the business workflow, not the framework, so the systems we ship stay easy to operate long after launch.",
        "icon": "Code2",
        "outcomes": [
    ...
    },
    {
        "slug": "cybersecurity",
        "title": "Cybersecurity",
        "short_description": "Security reviews, hardening, and governance support for digital operations.",
        "description": "We help teams identify risk, improve secure defaults, and build practical remediation plans that align engineering effort with business exposure. Our approach favors clear, prioritized action over generic checklists so security work fits inside real delivery timelines.",
        "icon": "ShieldCheck",
        "outcomes": [
    ...
    },
    {
        "slug": "ai-solutions",
        "title": "AI Solutions",
        "short_description": "Internal copilots, automation workflows, and data-enabled tools for operations.",
        "description": "We create practical AI systems that reduce repetitive work, improve response quality, and give teams better visibility into operational decisions. Every rollout includes human review checkpoints and measurable success criteria, so automation earns trust instead of just adding complexity.",
        "icon": "Bot",
        "outcomes": [
    ...
    },
    {
        ...
        "short_description": "Cloud infrastructure, CI/CD pipelines, and reliable deployment systems for growing teams.",
        "description": "We design cloud infrastructure that scales predictably and fails gracefully. From containerized deployments to automated pipelines and observability, we build the operational backbone that keeps applications reliable as usage grows.",
        "icon": "Cloud",
        "outcomes": [
    ...
    },
    {
        ...
        "short_description": "Research-informed interface design that turns complex workflows into clear digital products.",
        "description": "We design interfaces that hold up under real operational use, not just first impressions. From information architecture to interaction detail, our design process stays grounded in the workflows people actually rely on every day.",
        "icon": "PenTool",
        "outcomes": [
...
PROJECTS = [
    {
        ...
        "summary": "A secure role-based portal for leadership dashboards, internal workflows, and operational reporting.",
    ...
    },
    {
        ...
        "summary": "A centralized risk tracking interface for vulnerability evidence, remediation ownership, and audit readiness.",
    ...
    },
    {
        ...
        "summary": "An internal assistant that routes requests, drafts operational responses, and summarizes business data.",
    ...
    },
    {
        ...
        "category": "Web Platform",
        "summary": "A HIPAA-conscious scheduling and intake system connecting front-desk staff, clinicians, and patients across multiple locations.",
    ...
    },
    {
        ...
        "summary": "A monitoring and cost-attribution suite giving engineering leadership a real-time view of infrastructure spend and service health.",
...
JOBS = [
    {
        ...
        "location": "Remote",
        "type": "Full-time",
        "summary": "Build production web platforms with a focus on maintainability, performance, and enterprise delivery quality.",
        "responsibilities": [
    ...
    },
    {
        ...
        "location": "Hybrid",
        "type": "Contract",
        "summary": "Support security reviews, remediation planning, and practical governance for client systems.",
        "responsibilities": [
    ...
    },
    {
        ...
        "location": "Remote",
        "type": "Full-time",
        "summary": "Guide complex digital projects from discovery through launch with clear communication and delivery discipline.",
        "responsibilities": [
    ...
    },
    {
        ...
        "location": "Remote",
        "type": "Full-time",
        "summary": "Design and operate cloud infrastructure, CI/CD pipelines, and observability systems for client platforms.",
        "responsibilities": [
    ...
    },
    {
        ...
        "location": "Hybrid",
        "type": "Full-time",
        "summary": "Lead research-informed interface design for enterprise portals, dashboards, and internal tools.",
        "responsibilities": [
...
def seed_admin(db) -> None:
    ...
    db.add(admin)
    print(f"Created admin user: {ADMIN_EMAIL} / {ADMIN_PASSWORD} (change this password after first login)")


def seed_rows(db, model, rows: list[dict]) -> None:
    for row in rows:
        existing = db.scalar(select(model).where(model.slug == row["slug"]))
        if existing:
            continue
        db.add(model(**row))
    print(f"Seeded {model.__tablename__}: {len(rows)} rows checked")
...
def main() -> None:
    ...
    try:
        seed_admin(db)
        seed_rows(db, Service, SERVICES)
        seed_rows(db, Portfolio, PROJECTS)
        seed_rows(db, Blog, POSTS)
        seed_rows(db, Career, JOBS)
        db.commit()
        print("Seed complete.")
    finally:
        db.close()
