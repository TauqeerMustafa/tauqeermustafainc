...
export const clientSources: ClientSourceItem[] = [
  ...
  {
    id: "src-direct-wa",
    title: "Executive & Direct Desk WhatsApp",
    category: "communication",
    description: "Direct executive desk for enterprise proposals, strategic partnerships & leadership consulting",
    displayValue: company.whatsappChannels.direct.displayNumber,
    link: company.whatsappChannels.direct.url,
    verified: true,
    actionLabel: "Chat with Executive Desk",
  },
  {
    id: "src-sales-email",
