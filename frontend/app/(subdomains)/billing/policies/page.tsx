    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-10">
      ...
      <div className="text-center max-w-2xl mx-auto mb-6">
        ...
        <p className="mt-2 text-xs sm:text-sm text-ink-muted">
          Transparent guidelines governing invoices, milestone clearances, refunds, and corporate treasury compliance.
        </p>
      </div>

      {/* Main Policy Document */}
      <article className="border border-line-2 bg-surface p-6 sm:p-10 space-y-8 text-ink">
        ...
        <div className="border-l-4 border-action bg-card p-6 border border-line">
