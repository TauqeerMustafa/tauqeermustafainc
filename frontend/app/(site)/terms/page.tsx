...
export default function TermsOfServicePage() {
  return (
    <>
      ...
      <Section className="bg-[#FAFAFA]" labelledBy="terms-content">
        <article
          id="terms-content"
          className="mx-auto max-w-3xl rounded-none border border-[#E5E5E5] bg-white p-7 shadow-sm sm:p-10"
        >
          <h2 className="mb-4 mt-0 text-xl font-semibold text-[#0A0A0A]">1. Acceptance of Terms</h2>
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">2. Description of Services</h2>
          <p className="mb-6 text-base leading-8 text-[#171717]">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">3. Use of the Website</h2>
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">4. Intellectual Property</h2>
          <p className="mb-6 text-base leading-8 text-[#171717]">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">5. Fees and Payment</h2>
          <p className="mb-6 text-base leading-8 text-[#171717]">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">6. Confidentiality</h2>
          <p className="mb-6 text-base leading-8 text-[#171717]">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">7. Warranties and Disclaimers</h2>
          <p className="mb-6 text-base leading-8 text-[#171717]">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">8. Limitation of Liability</h2>
          <p className="mb-6 text-base leading-8 text-[#171717]">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">9. Termination</h2>
          <p className="mb-6 text-base leading-8 text-[#171717]">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">10. Governing Law</h2>
          <p className="mb-6 text-base leading-8 text-[#171717]">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">11. Changes to These Terms</h2>
          <p className="mb-6 text-base leading-8 text-[#171717]">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A0A0A]">12. Contact Us</h2>
