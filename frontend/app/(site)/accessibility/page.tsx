...
export default function AccessibilityPage() {
  return (
    <>
      ...
      <Section className="bg-[#F8FAFC]" labelledBy="accessibility-intro">
        <article
          id="accessibility-intro"
          className="mx-auto max-w-3xl rounded-none border border-[#E5E7EB] bg-white p-7 shadow-sm sm:p-10"
        >
          <h2 className="mb-4 mt-0 text-xl font-semibold text-[#0A1628]">Our Approach</h2>
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A1628]">Known Limitations</h2>
          <p className="mb-6 text-base leading-8 text-[#374151]">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-[#0A1628]">Reporting an Issue</h2>
          <p className="text-base leading-8 text-[#374151]">
            ...
            <a
              ...
              className="font-medium text-[#0A46A8] underline underline-offset-2"
            >
      ...
      <Section className="bg-white" labelledBy="accessibility-commitments">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {commitments.map((item) => (
            <Card key={item.title}>
              <h2 className="text-xl font-semibold text-[#0A1628]">{item.title}</h2>
