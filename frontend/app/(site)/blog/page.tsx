    ...
    <>
      ...
      <div className="bg-white px-5 pb-16 pt-32 sm:px-6 sm:pb-24 sm:pt-40">
        <div className="mx-auto max-w-[980px]">
          ...
          <h1 className="mt-4 max-w-4xl text-[56px] font-semibold leading-[1.07] tracking-[-0.374px] text-[#1d1d1f]">
            Practical guidance for engineering, security, and automation leaders.
          </h1>
          <p className="mt-6 max-w-2xl text-[21px] font-[400] leading-[1.38] tracking-[-0.374px] text-[#7a7a7a]">
      ...
      {/* Featured article */}
      <Section className="bg-[#f5f5f7]" labelledBy="featured-article">
        <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr] lg:items-center">
          <div>
            ...
            <h2
              id="featured-article"
              className="mt-4 text-[40px] font-semibold leading-[1.1] tracking-[-0.374px] text-[#1d1d1f]"
            >
              {featured.title}
            </h2>
            ...
            <div className="mt-8 flex flex-wrap gap-2">
              <span className="rounded-full border border-[#e0e0e0] bg-white px-3 py-1.5 text-[12px] font-semibold leading-none tracking-[-0.12px] text-[#7a7a7a]">
                {featured.category}
              </span>
              <span className="rounded-full border border-[#e0e0e0] bg-white px-3 py-1.5 text-[12px] font-semibold leading-none tracking-[-0.12px] text-[#7a7a7a]">
                {featured.date}
            ...
            <Link
              ...
              className="mt-6 inline-flex items-center justify-center rounded-full bg-[#0066cc] px-[22px] py-[11px] text-[17px] font-[400] leading-[1.47] tracking-[-0.374px] text-white transition-colors hover:bg-[#0071e3]"
            >
              Read Article
            </Link>
          </div>
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="text-[12px] leading-none tracking-[-0.12px] text-[#7a7a7a]">
                    {post.date}
                  </span>
                </div>
                ...
                <div className="mt-4 text-[12px] leading-none tracking-[-0.12px] text-[#7a7a7a]">
