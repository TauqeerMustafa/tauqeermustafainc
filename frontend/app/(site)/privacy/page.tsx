...
export default function PrivacyPolicyPage() {
  return (
    <>
      ...
      <Section className="bg-surface" labelledBy="privacy-content">
        <article
          id="privacy-content"
        ...
        >
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">1. Information We Collect</h2>
          <p className="mb-4 text-base leading-8 text-ink">
            We collect several types of information from and about users of our Site and clients of our services,
            including:
          </p>
          <ul className="mb-6 list-disc space-y-2 pl-6 text-base leading-7 text-ink">
            <li>
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">2. How We Use Your Information</h2>
          <p className="mb-4 text-base leading-8 text-ink">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">3. Cookies and Tracking Technologies</h2>
          <p className="mb-6 text-base leading-8 text-ink">
            ...
            <a href="/cookies" className="font-medium text-ink-2 underline underline-offset-2">
              Cookie Policy
            </a>
            .
          </p>

          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">4. How We Share Information</h2>
          <p className="mb-4 text-base leading-8 text-ink">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">5. Data Security</h2>
          <p className="mb-6 text-base leading-8 text-ink">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">6. Data Retention</h2>
          <p className="mb-6 text-base leading-8 text-ink">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">7. Your Rights and Choices</h2>
          <p className="mb-4 text-base leading-8 text-ink">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">8. International Data Transfers</h2>
          <p className="mb-6 text-base leading-8 text-ink">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">9. Children&apos;s Privacy</h2>
          <p className="mb-6 text-base leading-8 text-ink">
            Our Site and services are not directed to individuals under the age of 16, and we do not knowingly
            collect personal information from children.
          </p>

          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">10. Changes to This Policy</h2>
          <p className="mb-6 text-base leading-8 text-ink">
          ...
          <h2 className="mb-4 mt-10 text-xl font-semibold text-ink">11. Contact Us</h2>
