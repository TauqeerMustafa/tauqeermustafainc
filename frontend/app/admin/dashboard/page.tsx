...
type SectionTab = "operations" | "work" | "feed" | "all";

export default function AdminDashboardPage() {
  const [section, setSection] = useState<SectionTab>("operations");
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <Tabs tabs={sectionTabs} value={section} onChange={setSection} />
