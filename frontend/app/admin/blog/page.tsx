              ...
              {posts.map((post) => (
                <tr key={post.id} className="text-adm-text-2">
                  <td className="px-4 py-3">
                    ...
                    <p className="text-xs text-adm-text-3">/{post.slug}</p>
                  </td>
                  <td className="px-4 py-3 text-adm-text-2">{post.category}</td>
                  <td className="px-4 py-3">
                    <span
                      className={`px-2 py-1 text-xs font-semibold ${post.isPublished ? "bg-adm-green-light text-adm-green" : "bg-adm-surface-2 text-adm-text-3"}`}
                    >
