    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-4 mb-6">
        {[
          ...
          <div key={i} className="border border-adm-border bg-adm-surface p-5 transition hover:border-adm-border-2">
            <p className="text-xs font-semibold uppercase tracking-wider text-adm-text-3">{stat.label}</p>
      ...
      <div className="border border-adm-border bg-adm-surface">
        <div className="border-b border-adm-border px-5 py-4">
          <h3 className="font-semibold text-adm-text">Recent Leads</h3>
        </div>
        <table className="w-full text-left text-sm">
          <thead className="border-b border-adm-border bg-adm-surface-2">
            <tr>
              <th className="px-5 py-3 font-semibold text-adm-text-2">Company</th>
              <th className="px-5 py-3 font-semibold text-adm-text-2">Contact Person</th>
              <th className="px-5 py-3 font-semibold text-adm-text-2">Status</th>
              <th className="px-5 py-3 font-semibold text-adm-text-2">Value</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-adm-border">
            {[
              ...
              <tr key={i} className="transition hover:bg-adm-surface-2">
                <td className="px-5 py-3 font-medium text-adm-text">{lead.company}</td>
                <td className="px-5 py-3 text-adm-text-2">{lead.person}</td>
                ...
                <td className="px-5 py-3 text-adm-text-2">{lead.value}</td>
              </tr>
            ))}
          </tbody>
        </table>
