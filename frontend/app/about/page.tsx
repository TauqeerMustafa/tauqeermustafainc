...
export default function AboutPage() {
  return (
    <>
      <PageHero
        eyebrow="About"
        title="A focused engineering partner for serious digital work."
        description="Tauqeer Mustafa Inc. helps organizations plan, build, and improve secure software systems with a practical blend of product thinking, full-stack engineering, cybersecurity, and automation."
      >
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          ...
          <div className="grid gap-4">
            {[
              ...
              <div
                key={item}
                className="flex gap-3 rounded-lg border border-[#E5E7EB] bg-white p-5 shadow-sm"
              >
