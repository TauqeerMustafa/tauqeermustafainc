...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = [
    ...
    { url: "/support", changeFrequency: "daily", priority: 0.8 },
    { url: "/support/ticket", changeFrequency: "monthly", priority: 0.7 },
    { url: "/support/status", changeFrequency: "always", priority: 0.8 },
