...
export function ContactDossierPane({
  ...
  const isLine7 = channelId === "1291624014041103";
  const isLine6 = channelId === "1485319076722009";
  const isLine5 = channelId === "1739099617324219";
  const isLine4 = channelId === "2663451950739498";
  const isLine3 =
    channelId === "1034864159583818" ||
    channelId === "1083562997861778" ||
    (department === "direct" && !isLine4 && !isLine6);
  const isLine2 =
    channelId === "1318810581311680" ||
    (department === "support" && !isLine7 && !isLine5 && !isLine3);
        ...
        >
          ...
          <div className="mt-3">
            {isLine7 ? (
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20">
                <ShieldCheck size={12} />
                Line 6 (SL)
              </span>
            ) : isLine5 ? (
