      ...
      <div className="mx-auto grid max-w-[1200px] gap-14 px-5 py-12 sm:px-8 sm:py-20 lg:grid-cols-[minmax(0,1fr)_430px] lg:items-center lg:px-12">
        ...
        <div className="border border-line-2 bg-surface p-6 sm:p-8">
          ...
          <a
            ...
            className="inline-flex min-h-12 w-full items-center justify-center gap-3 border border-line-2 bg-white px-5 text-sm font-semibold transition hover:border-action"
          >
