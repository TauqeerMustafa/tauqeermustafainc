  ...
  return (
    <Section className="bg-white" labelledBy="about-title">
      <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <ImagePlaceholder src="https://res.cloudinary.com/b5cle1jv/image/upload/v1785442686/tmi-about-office_ugfz0w.jpg"
        ...
        <div className="order-1 lg:order-2">
          ...
          <div className="mt-7 max-w-3xl space-y-5 text-base leading-8 text-[#5F6673] sm:text-lg">
            <p>
              Since 2006, Tauqeer Mustafa Inc. has grown into a technology
              consulting and software engineering company spanning three
              service lines: AI systems and automation, cybersecurity and
